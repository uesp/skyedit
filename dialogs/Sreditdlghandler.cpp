...
srdlgcreateinfo_t l_SrDlgCreateInfo[] = {
	...
	{ &SR_NAME_AVIF, "Actor Value",		 CSrAvifView::IDD,   RUNTIME_CLASS(CSrAvifView),  RUNTIME_CLASS(CChildFrameFix),	_T("Tes5Mod:SkyEdit/User_Interface/Actor_Value"),	_T("Actor_Value") },
	...
	{ &SR_NAME_ECZN, "Encounter Zone",	 CSrEcznView::IDD,   RUNTIME_CLASS(CSrEcznView),  RUNTIME_CLASS(CChildFrameFix),	_T("Tes5Mod:SkyEdit/User_Interface/Encounter_Zone"),_T("Encounter_Zone") },
	...
	{ &SR_NAME_INGR, "Ingredient",	     CSrIngrView::IDD,   RUNTIME_CLASS(CSrIngrView),  RUNTIME_CLASS(CChildFrameFix),	_T("Tes5Mod:SkyEdit/User_Interface/Ingredient"),	_T("Ingredient") },
	...
	{ &SR_NAME_WOOP, "Word of Power",    CSrWoopView::IDD,   RUNTIME_CLASS(CSrWoopView),  RUNTIME_CLASS(CChildFrameFix),	_T("Tes5Mod:SkyEdit/User_Interface/Word_of_Power"), _T("Word_of_Power") },
...
bool CSrEditDlgHandler::SelectSoundFile (const char* pString) {
  ...
  if (strnicmp(pString, "\\data\\", 6) != 0  && strnicmp(pString, "data\\", 5) != 0 && strnicmp(pString, "data\\sound\\", 11) != 0 && strnicmp(pString, "sound\\", 6) != 0)
  {
	Buffer += pString;
  }
  else
